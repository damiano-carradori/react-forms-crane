...
export const StyledInput = styled.label`
  ...
  ${HiddenInput}.hasFocus + &{
    border-color: ${transparentize(.3, borderColor)}
  }
...
export const InputButton = styled.div`
  ...
  background-color: ${({ disabled }) => disabled ? buttonBackgroundColor : buttonBackgroundColor};
...
export const InputPlaceholder = styled.div
  ...
  color: ${transparentize(0.35, getTextColorForBackground(disabledBackgroundColor))};
